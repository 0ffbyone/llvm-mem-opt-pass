; ModuleID = './tests/IR/bb-three.ll'
source_filename = "bb-three.c"
...
8:                                                ; preds = %4
  %9 = tail call noalias dereferenceable_or_null(1024) ptr @malloc(i64 noundef 1024) #4
  tail call void @bar(ptr noundef %9) #3
  br label %11
