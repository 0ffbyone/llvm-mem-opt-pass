...
3:                                                ; preds = %1
  %4 = tail call noalias dereferenceable_or_null(4096) ptr @malloc(i64 noundef 4096) #3
  %5 = getelementptr inbounds i32, ptr %4, i64 10
  tail call void @bar(ptr noundef nonnull %5) #4
  %6 = getelementptr inbounds i32, ptr %4, i64 20
  tail call void @bar(ptr noundef nonnull %6) #4
  %7 = getelementptr inbounds i32, ptr %4, i64 30
  tail call void @bar(ptr noundef nonnull %7) #4
  %8 = getelementptr inbounds i32, ptr %4, i64 40
  tail call void @bar(ptr noundef nonnull %8) #4
  %9 = getelementptr inbounds i32, ptr %4, i64 50
  tail call void @bar(ptr noundef nonnull %9) #4
  br label %11
